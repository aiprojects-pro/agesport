...
(function () {
  ...
  // "Empleado público". Mantener sincronizado con config/catalogos.js
  // (backend).
  const ESPECIALIDADES = [
    ...
    { slug: 'empleado_publico', label: 'Empleado público', descripcion: 'Planificación, programación, ejecución, control y evaluación de actividades en la administración pública o empresa pública del ámbito deportivo.' },
